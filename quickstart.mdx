...
This quickstart proves the happy path without changing your AI client config. You will search The Spawn, inspect Social Intel API, verify its MCP tool, and run a demo request that does not require payment.
