...
This distinction matters because AI clients need a recovery message they can show to the user. However, lookup routes may still return compact `error` strings when there is no field-level validation context.
