...
If this output differs, rerun [Quickstart](/quickstart), then report the command, expected result, actual result, OS/tool version, and redacted output through [Community](/community).
